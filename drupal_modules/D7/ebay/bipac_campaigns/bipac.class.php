...
class Bipac {
   ...
   */
  function __construct($apikey, $group, $publisher, $test = FALSE) {
    $this->apikey = $apikey;
    $this->g = $group;
    $this->test = $test;
  }
   ...
   */
  public function FromAddressListLegislators($address_1, $address_2 = NULL, $city, $state, $zip, $RestrictStates = array(), $RestrictTypes = array()) {
    ...
    $data['state'] = $state;
    $data['zip'] = $zip;
    $data['RestrictStates'] = !empty($RestrictStates) ? implode(',', $RestrictStates) : NULL;
    $data['RestrictTypes'] = !empty($RestrictTypes) ? implode(',', $RestrictTypes) : NULL;
    $endpoint = $this->check_requirements($requirements, $data);
    return $this->query($endpoint, $data);
  }
  ...
  protected function run_query($endpoint, $data) {
    ...
    if (($result = drupal_http_request($endpoint, $options)) && (!empty($result->data)) && ($json = json_decode($result->data, TRUE))) {
      return $json;
    }
    else {
      $this->dump = $result;
  ...
  private function load_operations($operation = NULL) {
    ...
    /** Consumer APIs **/
    $operations['TestAPIKey'] = 'https://www.bipac.net/modules/JSON/TestAPIKey.asp';
    $operations['CampaignListAlerts'] = 'https://www.bipac.net/modules/JSON/CampaignListAlerts.asp';
    $operations['CampaignListLetterContent'] = 'https://www.bipac.net/modules/JSON/CampaignListLetterContent.asp';
    $operations['CampaignPostLetter'] = 'https://www.bipac.net/modules/JSON/CampaignPostLetter.asp';
    $operations['FromAddressListLegislators'] = 'https://www.bipac.net/modules/JSON/FromAddressListLegislators.asp';
    $operations['FromStateListLegislators'] = 'https://www.bipac.net/modules/JSON/FromStateListLegislators.asp';
    $operations['FromLatLonListLegislators'] = 'https://www.bipac.net/modules/JSON/FromLatLonListLegislators.asp';
    $operations['FromIDListLegislators'] = 'https://www.bipac.net/modules/JSON/FromIDListLegislators.asp';
    $operations['FromIDGetBio'] = 'https://www.bipac.net/modules/JSON/FromIDGetBio.asp';
    $operations['GetVoteRecord'] = 'https://www.bipac.net/modules/JSON/GetVoteRecord.asp';
    $operations['GetVoteScores'] = 'https://www.bipac.net/modules/JSON/GetVoteScores.asp';
    $operations['FromZIPListElections'] = 'https://www.bipac.net/modules/JSON/FromZIPListElections.asp';
    $operations['FromZIPListGOTV'] = 'https://www.bipac.net/modules/JSON/FromZIPListGOTV.asp';
    $operations['ListAvailablePages'] = 'https://www.bipac.net/modules/JSON/ListAvailablePages.asp';
    $operations['GetPageContent'] = 'https://www.bipac.net/modules/JSON/GetPageContent.asp';

    /** Reporting APIs **/
    $operations['RegistrationDownloads'] = 'https://www.bipac.net/modules/JSON/RegistrationDownloads.asp';
