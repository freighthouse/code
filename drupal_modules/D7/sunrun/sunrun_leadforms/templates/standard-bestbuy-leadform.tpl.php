...
<form action="//www.sunruntransit.com/track/lead" autocomplete="on" class="zeus-quote-form standard-leadform" id="zeus-quote-form" method="post">
    ...
    <div class="checkbox">
        <label>
            <input name="Additional_Services__c"  value="Energy Storage / Bright Box Battery" type="checkbox"> I'm interested in Brightbox Solar Battery Storage
        </label>
    </div>
    <div class="checkbox">
        <label>
    ...
    <input id="campid" type="hidden" name="campid" value="SRUN-BBY-WEB">
    ...
    <input type="hidden" id="retailStoreLocation" name="retailStoreLocation" value="0010d00001Iqa29">
