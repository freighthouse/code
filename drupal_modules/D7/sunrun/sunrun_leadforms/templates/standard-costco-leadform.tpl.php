...
<form action="//www.sunruntransit.com/track/lead" autocomplete="on" class="zeus-quote-form standard-leadform" id="zeus-quote-form" method="post">
    ...
    <input id="campid" type="hidden" name="campid" value="SRUN-COSTCO-WEB">
    <input type="hidden" name="ret_url" value="https://www.sunrun.com/ty/costco-thank-you">
    ...
    <input type="hidden" id="retailStoreLocation" name="retailStoreLocation" value="0010d00001Iqa1L">
