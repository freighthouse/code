...
<!--        Zip code field temporarily pointed at notes field-->
        <label for="00N60000001aGx2">Zip Code</label>
        <input class="form-control" id="00N60000001aGx2" maxlength="5" name="00N60000001aGx2" placeholder="99999" size="20" type="text" />
    </div>
    <div class="form-group">
        <label for="first_name">First Name</label>
        <input class="form-control" id="first_name" maxlength="40" name="first_name" placeholder="First Name" size="20" type="text" />
    </div>

    <div class="form-group">
        <label for="last_name">Last Name</label>
        <input class="form-control" id="last_name" maxlength="80" name="last_name" placeholder="Last Name" size="20" type="text" />
    </div>

    <div class="form-group">
        <label for="email">Email</label>
        <input class="form-control" id="email" maxlength="80" name="email" placeholder="<?php echo $email_placeholder; ?>" size="20" type="text" />
    ...
    <div class="form-group">
    <label class="" for="00N32000002xUJh">Average Monthly Electric Bill</label>
    <select class="form-control" id="00N32000002xUJh" name="00N32000002xUJh">
        <option value="default">-Select Average Monthly Bill-</option>
