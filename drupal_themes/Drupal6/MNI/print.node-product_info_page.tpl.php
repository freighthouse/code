...
<html xmlns="http://www.w3.org/1999/xhtml" lang="<?php print $print['language']; ?>" xml:lang="<?php print $print['language']; ?>">
  ...
  <body>
    ...
    <div class="print-content">
			<div class="main-heading"><?php print '<h2>' . $node->title.'</h2>'; ?></div>
			<div class="content">
			...
			<?php
				if ($node->field_download_pdf[0]['filepath'])
					print '<li><a href="' . base_path() . $node->field_download_pdf[0]['filepath'] . '">DOWNLOAD PRODUCT SHEET [PDF]</a></li>';
    ...
    <div class="print-footer"><div class="txt"><p>&copy; 2011 MNI</p></div></div><hr class="print-hr" />
