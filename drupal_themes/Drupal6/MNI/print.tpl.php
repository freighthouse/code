...
<html xmlns="http://www.w3.org/1999/xhtml" lang="<?php print $print['language']; ?>" xml:lang="<?php print $print['language']; ?>">
  ...
  <body>
    ...
    <div class="print-created">Created on <?php print format_date($print['node']->created, 'custom', 'l, F j, Y - H:i ', date("Z")) . " " . date("T"); ?></div>
    <div class="print-content"><?php print $print['content']; ?></div>
    <div class="print-taxonomy"><?php print $print['taxonomy']; ?></div>
    <div class="print-footer"><div class="txt"><p>&copy; 2011 MNI</p></div></div>
    <hr class="print-hr" />
