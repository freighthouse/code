...
(function ($, Drupal, window, document, undefined) {
	...
	$(".select2").change(function(e) {
		...
		var $form = $("#searchForm"),
		    ...
		    url = "/sites/all/themes/callfire_custom/php/international_rates.php";
	...
	if (window.Rainbow) window.Rainbow.linecount = (function(Rainbow) {
	    Rainbow.onHighlight(function(block) {
	        ...
	        $.each(lines, function(index, value) {
	            ...
	            var $row = $('<tr />', {class: 'rainbow-line rainbow-line-'});

	            $('<td />', {class: 'rainbow-line-number'}).appendTo($row).attr("data-number", index);
