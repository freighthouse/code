...
<div>
  <div class ="popup-content agreed">
    ...
    <div id="popup-buttons">
      <button type="button" class="hide-popup-button"><?php print 'Cacher / Cacher ce message' ?></button>
      <button type="button" class="find-more-button" ><?php print 'Non, je souhaite en savoir plus' ?></button>
    </div>
  </div>
</div>