...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php endif; ?>
    ...
    <?php
      ...
      hide($content['links']);
    ?>
    <div class="countable-page-wrapper">
      <?php print render($content['addtoany']); ?>
      <?php print render($content['field_featured_video_url']); ?>
      <?php print render($content['body']); ?>
      <?php print render($content['field_button_text_video']); ?>
      </div><br><br>
      <h3 style="text-align:center;"> SEE WHAT OTHERS ARE SAYING </h3>
    <div class="countable-fields-wrapper">
