	...
	<div class="content"<?php print $content_attributes; ?>>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><?php print $first_name; ?> <?php print $last_name; ?></h1>
                    <h2><?php print $position; ?></h2>

                    <?php print $body_text; ?>

					<!-- <a class="btn btn-yellow-rif blue-border" href="/about-rif/leadership-team-rif">Back to Leadership</a> -->
