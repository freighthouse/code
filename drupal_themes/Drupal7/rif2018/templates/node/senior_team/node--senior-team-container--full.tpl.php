<?php
	 ...
	 */
?>
<div id="node-<?php print $node->nid; ?>" class="node-senior-team <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
	...
	<div class="container"<?php print $content_attributes; ?>>
		...
		<?php foreach($content['field_senior_team_member_list'] as $key => $value) : ?>
