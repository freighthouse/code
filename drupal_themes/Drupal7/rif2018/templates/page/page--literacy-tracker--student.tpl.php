...
<div id="main-wrapper" data-current-uid="<?php print $user->uid;?>">
	<div id="main">
		...
		<div id="content" class="column" style="background-color:#FFFFFF;">
			<div class="section">
				<a id="main-content"></a>
...
<!--			<div class="container">-->
<!--				<div class="tabs">-->
<!--					--><?php //print render($tabs); // We do not display tabs as they will their placement will be decided on a per page basis*/?>
<!--				</div>-->
<!--			</div>-->
		<?php endif; ?>
...
<!--					<img alt="Reading is Fundamental Logo" title="Reading is Fundamental" style="width: 139px; height: 144px;" class="media-element file-imgresponsive" data-delta="1" typeof="foaf:Image" src="/sites/default/files/Internal%20Layout/rif-logo-footer_0.png" width="139" height="144">-->
<!--				</div>-->
<!--			</div>-->
<!--		</div>-->
<!--		--><?php //if ($page['footer']): ?>
