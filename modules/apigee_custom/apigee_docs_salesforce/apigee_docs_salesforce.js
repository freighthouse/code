...
Drupal.behaviors.webformSupportFormDescription = {
  attach: function (context, settings) {
    $('#edit-submitted-request-details-description', context).once('webform-support-form-description', function () {
      var $field = $(this);
    ...
    $('#edit-submitted-request-details-service', context).once('webform-support-form-service', function() {
