...
var testGetWebform = function(endpoint, webform, callback) {
    asyncTest(
        'Get Webform', function() {
            expect(3);
            getWebform(
                endpoint, webform, function(retrieved) {
...
var testUpdateWebform = function(endpoint, webform, callback) {
    asyncTest(
        'Update Webform', function() {
            ...
            updateWebform(
                endpoint, webform, function(webform) {
...
var testDeleteWebform = function(endpoint, webform, callback) {
    asyncTest(
        'Delete Webform', function() {
            expect(1);
            deleteWebform(
                endpoint, webform, function(status) {
                    ok(!!status);
                    start();
                    callback(status);
                }
...
var testGetSubmission = function(endpoint, submission, callback) {
    asyncTest(
        'Get Submission', function() {
            expect(1);
            getSubmission(
                endpoint, submission, function(submission) {
                    ok(!!submission);
                    start();
                    callback(submission);
                }
...
var testDeleteSubmission = function(endpoint, submission, callback) {
    asyncTest(
        'Delete Submission', function() {
            expect(1);
            deleteSubmission(
                endpoint, submission, function(status) {
                    ok(!!status);
                    start();
                    callback(status);
                }
