        ...
        jQuery(window).resize(
            function() {
                if (globals.trigger !== 0) {
                    ...
                    globals.resizeTimer = window.setTimeout(
                        function() {
    ...
    process = {
        ...
        additional: function additional() {
            if(jQuery(globals.additional).length) {
                jQuery(globals.additional).find('li').each(
                    function() {
...
function modCampaignMonitorEmailSignups(placeholder) {
    ...
    jQuery('.campaignmonitor-subscribe-form .form-item-email input').val(emailText).focus(
        function() {
            me = jQuery(this);
    ...
    jQuery('.campaignmonitor-subscribe-form').submit(
        function () {
