...
<div class="main-container <?php print $container_class; ?>">
  ...
  <div class="container page_tabs node_tabs">
    ...
    <div class="col-sm-2 col-xs-12 news_button_div">
      <a class="btn news_button" href="../news-events/conferences" type="button" style="width:116%;background-color:#ed9b33!important;color:#fff!important">Conferences</a>
    </div>
    <div class="col-sm-2 col-xs-12 news_button_div">
  ...
  <div class="row">
    ...
    <section<?php print $content_column_class; ?>>
      ...
      <div class="container">
        ...
        <div class="page_back">
          <p>&nbsp;</p>
            <a class="btn btn-default back_button" href="../news-events/conferences">Back to conferences</a>
          <p>&nbsp;</p>
        </div>
      </div>
    </section>
