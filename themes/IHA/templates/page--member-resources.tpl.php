      ...
      <?php if (user_is_anonymous()) {
        <div class="row">
          <div class="col-xs-12 col-sm-3">
            <button class="btn btn-default register_button" href="cas?destination=node" style="width:100%">Login</button>
          </div>
          <div class="col-xs-12 col-sm-3">
            <button class="btn btn-default register_button" href="cas?destination=node" style="width:100%">Request Access</button>
          </div>
        </div>
      }
      <?php endif; ?>
