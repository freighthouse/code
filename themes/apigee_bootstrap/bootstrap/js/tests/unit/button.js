$(
    function () {
        ...
        test(
            'should return set state to loading', function () {
        ...
        test(
            'should return reset state', function () {
                var btn = $('<button class="btn" data-loading-text="fat">mdo</button>')
                equal(btn.html(), 'mdo', 'btn text equals mdo')
                btn.button('loading')
                equal(btn.html(), 'fat', 'btn text equals fat')
        ...
        test(
            'should toggle active when btn children are clicked', function () {
        ...
        test(
            'should toggle active when btn children are clicked within btn-group', function () {
        ...
        test(
            'should check for closest matching toggle', function () {
