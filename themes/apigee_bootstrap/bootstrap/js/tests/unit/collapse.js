$(
    function () {
        ...
        test(
            'should show a collapsed element', function () {
        ...
        test(
            'should hide a collapsed element', function () {
        ...
        test(
            'should reset style to auto after finishing opening collapse', function () {
                $.support.transition = false
                stop()
        ...
        test(
            'should add active class to target when collapse shown', function () {
                $.support.transition = false
                stop()
        ...
        test(
            'should remove active class to target when collapse hidden', function () {
                $.support.transition = false
                stop()
        ...
        test(
            'should remove active class from inactive accordion targets', function () {
                $.support.transition = false
                stop()
        ...
        test(
            'should allow dots in data-parent', function () {
                $.support.transition = false
                stop()
