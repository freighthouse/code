$(
    function () {
        ...
        test(
            'should render popover element', function () {
        ...
        test(
            'should store popover instance in popover data object', function () {
                $.support.transition = false
                var popover = $('<a href="#" title="mdo" data-content="http://twitter.com/mdo">@mdo</a>')
                .popover()
        ...
        test(
            'should get title and content from options', function () {
                $.support.transition = false
        ...
        test(
            'should get title and content from attributes', function () {
                $.support.transition = false
        ...
        test(
            'should get title and content from attributes #2', function () {
                $.support.transition = false
                var popover = $('<a href="#" title="@mdo" data-content="loves data attributes (づ｡◕‿‿◕｡)づ ︵ ┻━┻" >@mdo</a>')
                .appendTo('#qunit-fixture')
                .popover(
        ...
        test(
            'should destroy popover', function () {
